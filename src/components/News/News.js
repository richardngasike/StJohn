...
const news = [
  {
    ...
    category: 'Admissions',
    tag: 'Important',
    title: '2026/2025 Academic Year Applications Now Open',
    excerpt: 'The admissions portal is now open for the new academic year. Apply for certificate, diploma, and short courses before August 30, 2026.',
    date: 'July 15, 2026',
    readTime: '3 min read',
    featured: true,
    color: 'green',
  },
  {
    ...
    category: 'Events',
    tag: 'Upcoming',
    title: 'Annual Graduation Ceremony: Class of 2026',
