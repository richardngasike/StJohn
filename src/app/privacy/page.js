        ...
        <div className="container">
          <div style={{ maxWidth: 780, margin: '0 auto', background: 'white', borderRadius: 20, padding: '48px', border: '1px solid var(--border-light)', boxShadow: 'var(--shadow-sm)' }}>
            {[
              ...
              { title: '6. Contact Us', body: 'For privacy-related enquiries, contact our Data Protection Officer at privacy@stjohnscollege.ac.ke or call +254 720 215 715. Last updated: July 2026.' },
            ].map((s, i) => (
